...
ビット列を解読する以下のようになります。
- 01: Capability Code 1 = Multiprotocol Extensions (MBGP) [https://www.iana.org/assignments/capability-codes/capability-codes.xhtml]
- 04: Length (長さ4バイト) 
- 00 19: AFI (Address Family Identifier) = 25 (L2VPN) [https://www.iana.org/assignments/address-family-numbers/address-family-numbers.xhtml]
- 00 46: SAFI (Subsequent Address Family Identifier) = 70 (EVPN) [https://www.iana.org/assignments/safi-namespace/safi-namespace.xhtml]
